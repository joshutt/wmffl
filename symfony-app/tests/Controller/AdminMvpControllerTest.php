...
class AdminMvpControllerTest extends TestCase
{
    ...
    // ---- GET /admin/mvp/{season}/{week} (explicit params) ----

    public function testIndexRedirectsWhenNotCommissionerWithExplicitParams(): void
    {
        [$controller, $auth, $seasonWeek, $em, $scoring] = $this->makeController(commissioner: false);
    ...
    {
        // Scoring service returns 15 players; overall should be capped at 10
        $players = array_map(
    ...
    public function testIndexQueriesDatabaseWithCorrectSeasonAndWeek(): void
    {
    ...
    {
        $controller = new class extends AdminMvpController {
