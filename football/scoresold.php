...
$sql = "SELECT wm.weekname, wm.week, s.teama, if(s.scorea>=s.scoreb,t1.name, t2.name) as 'leadname', if(s.scorea>=s.scoreb,s.scorea,s.scoreb) as 'leadscore', if(s.scorea>=s.scoreb,t2.name, t1.name) as 'trailname', if(s.scorea>=s.scoreb,s.scoreb,s.scorea) as 'trailscore', s.label  FROM weekmap wm, schedule s, team t1, team t2
...
<TR><TD height='32' align='center' bgcolor="#660000" colspan="3">
<?
$first = true;
while (list($weekname, $week, $team1, $leader, $leadscore, $trail, $trailscore, $label) = mysql_fetch_row($results)) {
if ($first) {

?>
<FONT class='SectionHeader'><? print strtoupper($weekname); ?> SCORES</FONT></TD></TR>

<tr><td height="2" colspan="3"><font class="NFLNewsDate"><hr height="1"/></font></td></tr>
...
if ($label != "") {
?>
<tr><td height="10" colspan="3" align="center"><a href="" class="NFLHeadline">
<? print $label; ?></a></td></tr>
<?
}
?>
