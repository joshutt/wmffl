...
if ($isin) {
    ...
    <div class="container">
        ...
        <P>Step 2: Change the 'Available' tag to 'Pick Up' for any players you are interested in. If you only want to
            drop
            players or change your waiver priorities skip this step.</P>
        ...
        <FORM ACTION="list.php" METHOD="POST">
            ...
            <SELECT NAME="Available">
                ...
                <OPTION VALUE="available" <? if ($Available == "available") print "SELECTED "; ?>>Available Players
                </OPTION>
        ...
        <TABLE>
            <FORM ACTION="confirm.php" METHOD="POST">
                <TR>
                    <TD>
                        <B><A HREF="list.php?Position=<? print $Position; ?>&Team=<? print $Team; ?>&Available=<? print $Available; ?>&Order=teamname&submit=y&Last=<? print $Last; ?>&First=<? print $First; ?>">Current
                                Team</A></B></TD>
                    <TD>&nbsp;&nbsp;&nbsp;</TD>
                    <TD>
                        <B><A HREF="list.php?Position=<? print $Position; ?>&Team=<? print $Team; ?>&Available=<? print $Available; ?>&Order=lastname&submit=y&Last=<? print $Last; ?>&First=<? print $First; ?>">Last
                                Name</A></B></TD>
                    <TD>&nbsp;&nbsp;&nbsp;</TD>
                    <TD>
                        <B><A HREF="list.php?Position=<? print $Position; ?>&Team=<? print $Team; ?>&Available=<? print $Available; ?>&Order=firstname&submit=y&Last=<? print $Last; ?>&First=<? print $First; ?>">First
                                Name</A></B></TD>
                    <TD>&nbsp;&nbsp;&nbsp;</TD>
                    <TD>
                        <B><A HREF="list.php?Position=<? print $Position; ?>&Team=<? print $Team; ?>&Available=<? print $Available; ?>&Order=position&submit=y&Last=<? print $Last; ?>&First=<? print $First; ?>">Pos</A></B>
                    </TD>
                    <TD>&nbsp;&nbsp;&nbsp;</TD>
                    <TD>
                        <B><A HREF="list.php?Position=<? print $Position; ?>&Team=<? print $Team; ?>&Available=<? print $Available; ?>&Order=nflteam&submit=y&Last=<? print $Last; ?>&First=<? print $First; ?>">NFL
                                Team</A></B></TD>
                </TR>
                <?
                if ($theset) {
