...
//            array_push($theyItems, loadPlayer($conn, substr($value, 4)));
...
*/
    ...
    $teamA = loadTeam($conn, $teamnum);
    $trade = loadTradeByID($conn, $offerid, $teamA);
...
//print_r($youItems);
    ...
    //print "Accept";
        ...
        $isValid = validateTrade($conn, $offerid, $teamnum);
    //print "Valid: ".$isValid;
        if (!$isValid) {
        ...
        acceptTrade($conn, $offerid, $teamnum);
	}
}
