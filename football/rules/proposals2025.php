...
<div class="container">
    <p>This is the list of proposals to be voted on for the 2025 WMFFL season.</p>

    <p>To vote on any issues currently open, you may do so on the <a href="ballot">Ballot</a></p>
    ...
    <div class="card m-3 p-2 bg-light">
        ...
        <p>
            Made 0-39 yards = 1 pts<br/>
            Made 40-49 yards = 2 pts<br/>
            Made 50-59 yards = 3 pts<br/>
            Made 60+ yards = 5 pts
        </p>

        Missed kicks and EPs would be unchanged. Based on my numbers, this would reduce overall kicker points by about
        40%.
        <blockquote class="mb-0 mt-2 px-3"><i>Change text in rule V.B.5.b to read:<br/>
                <blockquote>
                    b. Field Goal <br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;i. Made 0-39 yards = 1 pt<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;ii. Made 40-49 yards = 2 pts<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;iii. Made 50-59 yards = 3 pts<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;iv. Made 60+ yards = 5 pts<br/>
                    &nbsp;&nbsp;&nbsp;&nbsp;v. Missed 0-30 yards = -1 pt
                </blockquote>
            </i></blockquote>
    </div>
    ...
    <div class="card m-3 p-2 bg-light">
        ...
        <p>I propose eliminating the head coach position. In the past, I supported the head coach. But, I changed my
            ...
            difference between the strength of your coach’s NFL team and the relative strength of their opponents. This
            really has nothing to do with fantasy football.</p>
        <blockquote class="mb-0 mt-2 px-3"><i>Repeal rule II.E.1.f<br/>
                Repeal rule IV.B.10<br/>
                Remove the words '1 HC,' from rule V.A.2<br/>
                Repeal rule V.A.4<br/>
                Repeal rule V.B.8<br/>
                Repeal rule IX.H
            </i></blockquote>
    </div>
    ...
    <div class="card m-3 p-2 bg-light">
        ...
        <p> I propose changing the selection of individual defensive lineman to simply selecting a defensive line from
            ...
            differently? Does anyone really care about individual defensive lineman?</p>

        <blockquote class="mb-0 mt-2 px-3"><i>Change text in rule IV.B.7 to read 'Defensive Line Units'<br/>
                Change text in rule V.A.2 from '2 DL,' to '1 DL'
            </i></blockquote>
    </div>
    ...
    <div class="card m-3 p-2 bg-light">
        ...
        <blockquote class="mb-0 mt-2 px-3"><i>Change the text in rule V.A.2 by removing the words '1 TE,' and changing
                '1 additional player' to '2 additional players'
            </i></blockquote>
    </div>
    ...
    <div class="card m-3 p-2 bg-light">
        ...
        <blockquote class="mb-0 mt-2 px-3"><i>Change text in rule IV.B.7 to read 'Defensive Line (sub-designated as defensive ends and defensive tackles)'<br/>
                Update rule V.A.2 to replace '2 DL,' with '3 DL (at least one of which must be a DT)'<br/>
            </i></blockquote>
    </div>
    ...
    <div class="card m-3 p-2 bg-light">
        ...
        <blockquote class="mb-0 mt-2 px-3"><i>Change text in rule IV.B.9 to read 'Defensive Backs (sub-designated as cornerbacks and safeties)'<br/>
                Update rule V.A.2 to replace '2 LB, 2 DB and' with '1 LB, 1 S, 1 CB, ' and add the text ' and 2 additional players at either LB or DB' to the end<br/>
            </i></blockquote>
    </div>
