...
<p>This is the list of proposals to be voted on for the 2022 WMFFL season.
...
<div class="card m-3 p-2 bg-light">
    <b>Proposal 2022.2 - All missed FG get -1 pt</b>
    <b>Sponsor: Richard Lawson</b><br/>
    <span class="ballot">Status: <span class="status">Under Discussion</span></span><br/>
...
<div class="card m-3 p-2 bg-light">
    ...
    <li>If A is leading B by 4 points and throws a TD with 5 seconds left they go 2 points up and the PAT would not result in a bonus 5 points (going from a win to a win)</li></ul></li>
    <li>Is a walk off kick in OT</li></ul>
    <blockquote class="mb-0 mt-2 px-3"><i>Add rule V.B.5.c reading:<br/>
        c. Game Winning and Tying Field Goals<br/>
        &nbsp;&nbsp;&nbsp;&nbsp;i. Game winning or tying FG with fewer than 20 seconds left in the game or in overtime = 5 pts
        </i></blockquote>
</div>
...
<div class="card m-3 p-2 bg-light">
    ...
    <span class="ballot">Status: <span class="status">Under Discussion</span></span><br/>
     ...
     Burgundy #1 vs Gold #4<br/>
     Burgundy #2 vs Gold #3<br/>
     Burgundy #3 vs White #2<br/>
     Burgundy #4 vs White #1<br/>
     Gold #1 vs White #4<br/>
     Gold #2 vs White #3</p>

     <p>In odd number years<br/>
     Burgundy #1 vs White#4<br/>
     Burgundy #2 vs White#3<br/>
     Burgundy #3 vs Gold#2<br/>
     Burgundy #4 vs Gold#1<br/>
     White #1 vs Gold#4<br/>
     White#2 vs Gold#3</p>
     </blockquote>
    <blockquote class="mb-0 mt-2 px-3"><i>In rule I.D change '14 weeks' to '15 weeks'<br/>
        </i></blockquote>
</div>
