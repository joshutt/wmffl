...
<div class="container">
<p>This is the list of proposals to be voted on for the 2024 WMFFL season.
...
<div class="card m-3 p-2 bg-light">
    ...
    <blockquote class="mb-0 mt-2 px-3"><i>Change text in rule IV.A from '25' to '26'<br/>
            Repeal rule IV.C
        </i></blockquote>
</div>
    ...
    <blockquote class="mb-0 mt-2 px-3"><i>Change rule IV.C.4 to read:<br/>
            <blockquote>
            4. Any player on the IR on Friday and removed from the NFL IR on Saturday or Sunday of a given week, will not count against the
            roster limits in IV.A for that given week unless they are activated as a starter by the WMFFL team.</blockquote>
        </i></blockquote>
</div>
