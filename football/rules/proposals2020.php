...
<div class="card m-2 p-2 bg-light">
    ...
    be
    activated. Once removed from the IR by the NFL team, the player must be removed from the WMFFL IR and the team must
    restore
    ...
    <blockquote class="mb-0 mt-2 px-3"><i>Add rule IV.C reading:<br/>
            ...
            &nbsp;&nbsp;&nbsp;&nbsp; 2. Any player on IR will not be counted towards the roster limits in rule
            IV.A.<br/>
...
<div class="card m-2 p-2 bg-light">
    ...
    <blockquote class="mb-0 mt-2 px-3"><i>Add rule V.A.3.d (or V.A.3.e if proposal 2020.1 passes) reading:</br>
            d. Failure to activate a player whose NFL team plays on Monday will result in the flex position activation
            being treated as if they were not on an NFL team</br>
            &nbsp;&nbsp;&nbsp;&nbsp; i. This restriction will be waived in any week where there are not any NFL games
...
<div class="card m-2 p-2 bg-light">
    ...
    available for keeping per normal costs. <br/>
...
<div class="card m-2 p-2 bg-light">
    ...
    <blockquote class="mb-0 mt-2 px-3"><i>Section IX of the rules will not apply for the 2020 season<br/>
        The fines laid out in rule V.A.3 will not be accumulated for the 2020 season<br/>
        The rule VI.E.3.c will not be enforced in 2020.</i></blockquote>
</div>
