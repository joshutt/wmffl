...
<body id="body_ajax_ld" onresize="resize()">
            ...
            <td width="49%" valign="top">
                ...
                <table class="draft_picks_header report" cellspacing="1" align="center">
                    <tbody>
                        ...
                        <tr class="oddtablerow">
                            <th>Team:</th>
                            <td id="pickFormTeam"><select name="team">
                            </select>
                            </td>
                        </tr>
                ...
                <table class="draft_picks_header report" cellspacing="1" align="center">
                    <tbody>
                        ...
                        <tr class="eventablerow">
                            ...
                            <td align="center"><a class="tools" onClick="doUpdate();">Force Update</a></td>
                            <td align="center"><a class="tools" onClick="logOut();">Log Out</a></td>
                        </tr>
                        <tr class="eventablerow">
                            <td align="center"><a class="tools" id="showChat" onClick="showChat();">Hide Chat</a></td>
                            <td align="center"></td>
                            <td align="center"><a class="tools" id="showRoster" onClick="switchRoster();">Show Rosters</a></td>
                        </tr>
                        <tr class="eventablerow" id="commishRow">
                            <td align="center"><a class="tools" onClick="switchLoad();">Toggle Update</a></td>
                            <td align="center"><a class="tools" onClick="stopClock();" id="stclock">Stop Clock</a></td>
                            <td align="center"><a class="tools" onClick="undoPick();" id="undo"></a></td>
                        </tr>
                        <tr class="oddtablerow" id="logInInfo">
                            <td colspan="3">
                                <form id="logInForm" method="post" onSubmit="doLogIn(); return false;"><table>
                                    <tbody>
                                        <tr>
                                            <th>Team:</th>
                                            <td><select name="team">
                                                ...
                                                <option value="10">Whiskey Tango</option></select>
                                            </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Password:</th>
                                            <td><input type="password" name="pass" onKeyPress="return submitenter(this, event)"/>
                        ...
                        <tr class="oddtablerow" id="logOutInfo">
                            <td colspan="3">
                                <form id="logOutForm"><table>
                                    <tbody>
                                        <tr>
                                            <td id="loutTeam"><select name="team">
                                            </select>
                                            <td>
                ...
                <tr><td>
                    <form name="chatForm" action="" onSubmit="postMessage(); return false;">
                        ...
                        <input type="button" value="Clear Messages" onClick="clearMessages()" />
                    </form>
                </td></tr>
                </tbody>
                </table>
                ...
                <table class="draft_picks_header report" cellspacing="1" align="center" id="rosterTeam">
                    <tbody>
                        <tr><th>Rosters</th></tr>
                        <tr><td align="center">
                            ...
                            <a onClick="displayRoster('4')" class="teamRoster">LBC</a> - 
                            <a onClick="displayRoster('7')" class="teamRoster">MM</a> - 
                            <a onClick="displayRoster('3')" class="teamRoster">NOR</a> - 
                            <a onClick="displayRoster('1')" class="teamRoster">PNH</a> - 
                            <a onClick="displayRoster('5')" class="teamRoster">SOB</a> - 
                            <a onClick="displayRoster('2')" class="teamRoster">WER</a> - 
                            <a onClick="displayRoster('10')" class="teamRoster">WT</a>
                        </td></tr> 
                        <tr><td valign="top">
