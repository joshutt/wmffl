<?
require_once "../tmutils/start.php";
...
<tr><th>Image:</th><td><input type="text" name="url"/></td></tr>
<tr><th>Caption:</th><td><input type="text" name="caption"/></td></tr>
<tr><th>Location:</th><td><input type="text" name="location"/></td></tr>
<tr><th>Body:</th><td><textarea></textarea></td></tr>
</table>
</form>
