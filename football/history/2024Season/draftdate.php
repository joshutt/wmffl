...
The default date for the draft is August 24th.  As always we check to see if a better date is available.  Please fill out the below form, letting us know when you can NOT make the draft.  You are limited to selected 4 dates you can not attend.  The date will be announced on or about August 10th.</p>
...
<H1 ALIGN=Center>Draft Date Open <?= $currentSeason ?></H1>
<HR size = "1"/>
